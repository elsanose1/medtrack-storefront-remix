        ...
        <div>
          <Link to="/" className="block text-center">
            <h1 className="text-4xl font-bold tracking-tight text-neutral-900">
              <span className="text-indigo-600 hover:text-indigo-700">Med</span>Track
            </h1>
          </Link>
        ...
        <Form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              ...
              className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white ${
                isLoading
                  ? "bg-indigo-400"
                  : "bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              }`}>
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-neutral-600">
              <Link
                to="/"
                className="font-medium text-indigo-600 hover:text-primary-700">
                ← Back to Home
              </Link>
            </p>
          </div>
